export function deleteCarOnButtonClick(event, cars, setCars) {
    ...
    const newCars = cars.filter(car => 
        car.mark !== carMarkToDelete || 
        car.model !== carModelToDelete || 
        car.type !== carTypeToDelete || 
        car.releaseYear != carReleaseYearToDelete || 
        car.regExpireDate != carRegExpiryToDelete
    );
