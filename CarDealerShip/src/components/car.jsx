...
const Car = ({ mark, model, type, releaseYear, regExpireDate, cars, setCars }) => {
    ...
    return (
        <div className={isExpired ? "car-card expired" : "car-card"}>
            ...
            <button className="delete-button" onClick={(event) => deleteCarOnButtonClick(event, cars, setCars)}>Delete</button>
        </div>
    );
}
